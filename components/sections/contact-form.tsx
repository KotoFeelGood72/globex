...
export function ContactForm() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(responseData.error || 'Произошла ошибка при отправке формы');
      }
  ...
  return (
    <section 
      className="relative min-h-[90vh] flex items-center py-24 md:-mt-48 bg-background"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-lg text-foreground/60 mb-8">
              Расскажем, как оптимизировать платежные процессы вашего бизнеса, снизить комиссии и ускорить проведение транзакций. Подберем оптимальные решения под ваши задачи.
            </p>
