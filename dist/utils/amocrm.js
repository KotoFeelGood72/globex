...
class AmoCRMService {
    ...
    async getPipelines() {
        ...
        try {
            ...
            const response = await axios_1.default.get(`https://${this.apiDomain}/api/v4/leads/pipelines`, {
                headers: {
                    'Authorization': `Bearer ${this.config.accessToken}`,
                    'Content-Type': 'application/json'
                }
            ...
            console.error('Error getting pipelines:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
            throw error;
        }
    }
}
